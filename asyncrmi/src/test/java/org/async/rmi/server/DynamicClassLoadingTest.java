...
public class DynamicClassLoadingTest {
    ...
    public static void beforeClass() throws IOException {
        move("build/classes/java/test/org/async/rmi/server/SimpleObject.class", "target/tmp/org/async/rmi/server/");
    }


    @AfterClass
    public static void afterClass() throws IOException {
        move("target/tmp/org/async/rmi/server/SimpleObject.class", "build/classes/java/test/org/async/rmi/server/");
    }
    ...
    public void testLoadFromURL() throws Exception {
        ...
        org.hamcrest.MatcherAssert.assertThat   (objRead.getClass().getName(), is("org.async.rmi.server.SimpleObject"));

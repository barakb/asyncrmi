...
public class DynamicExporter implements Exporter {
    ...
    private final Map<Long, Remote> exportedObjects;
    ...
    private  <T extends Remote> T createProxy(T impl, long objectId) throws UnknownHostException, InterruptedException {
